...
('00000000-0000-0000-0000-000000000000', 'Inbox', '📥', 1, 0, '$NOW', '$NOW');

-- Insert Lists
INSERT INTO lists (id, name, icon, is_inbox, sort_order, created_at, updated_at) VALUES
('11111111-1111-1111-1111-111111111111', 'Work', '💼', 0, 1, '$NOW', '$NOW'),
('22222222-2222-2222-2222-222222222222', 'Personal', '🏠', 0, 2, '$NOW', '$NOW'),
('33333333-3333-3333-3333-333333333333', 'Shopping', '🛒', 0, 3, '$NOW', '$NOW');

-- Insert Tags
INSERT INTO tags (id, name, color, created_at) VALUES
('aaaa1111-1111-1111-1111-111111111111', 'urgent', '#ff5555', '$NOW'),
('aaaa2222-2222-2222-2222-222222222222', 'bug', '#ff79c6', '$NOW'),
('aaaa3333-3333-3333-3333-333333333333', 'feature', '#50fa7b', '$NOW'),
('aaaa4444-4444-4444-4444-444444444444', 'docs', '#8be9fd', '$NOW'),
('aaaa5555-5555-5555-5555-555555555555', 'review', '#ffb86c', '$NOW');
...
('bbbb1111-1111-1111-1111-111111111111', 'Review pull request for auth module', 'Check OAuth implementation and security headers', 'https://github.com/example/repo/pull/123', 'high', 0, '11111111-1111-1111-1111-111111111111', '$NOW', '$NOW'),
('bbbb2222-2222-2222-2222-222222222222', 'Fix production memory leak', 'Memory leak in authentication service causing OOM', NULL, 'urgent', 0, '11111111-1111-1111-1111-111111111111', '$NOW', '$NOW'),
('bbbb3333-3333-3333-3333-333333333333', 'Write API documentation', 'Document REST endpoints for v2 API', 'https://docs.example.com', 'medium', 0, '11111111-1111-1111-1111-111111111111', '$NOW', '$NOW'),
