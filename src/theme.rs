...
//!
//! Tickit supports popular terminal color schemes out of the box.
//! Each theme defines colors for UI elements like accents, backgrounds,
//! text, selections, and more.
//!
//! Themes are identical to Hazelnut/Feedo for consistency.
...
impl ThemeColors {
    ...
    pub fn from_palette(p: ThemePalette) -> Self {
        ...
        Self {
            ...
            // Priority colors derived from semantic colors
            priority_low: p.muted,
            priority_medium: p.info,
            priority_high: p.warning,
            priority_urgent: p.error,
        }
    }
    ...
    pub fn priority_style(&self, priority: crate::models::Priority) -> Style {
        let color = match priority {
            crate::models::Priority::Low => self.priority_low,
            crate::models::Priority::Medium => self.priority_medium,
            crate::models::Priority::High => self.priority_high,
            crate::models::Priority::Urgent => self.priority_urgent,
        };
